namespace _06._Full_Directory_Traversal
{
    using System;
    ...
    public class Program
    {
        public static void Main()
        {
            ...
            using (var writer = new StreamWriter($"{Environment.GetFolderPath(Environment.SpecialFolder.Desktop)}/AllDirectotriesReport.txt"))
            {
